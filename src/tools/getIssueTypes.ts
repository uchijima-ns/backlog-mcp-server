...
export const getIssueTypesTool = (backlog: Backlog, { t }: TranslationHelper): ToolDefinition<ReturnType<typeof getIssueTypesSchema>, CallToolResult> => {
  return {
    ...
    handler: async ({ projectIdOrKey }) => 
      withErrorHandling(() => backlog.getIssueTypes(projectIdOrKey))
  };
};
