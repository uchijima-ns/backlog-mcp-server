...
export const getWikisCountTool = (backlog: Backlog, { t }: TranslationHelper): ToolDefinition<ReturnType<typeof getWikisCountSchema>, CallToolResult> => {
  return {
    ...
    handler: async ({ projectIdOrKey }) => 
      withErrorHandling(() => backlog.getWikisCount(projectIdOrKey))
  };
};
